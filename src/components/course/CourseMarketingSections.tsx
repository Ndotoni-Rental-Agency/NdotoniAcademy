    ...
    <>
      ...
      <section className="border-t border-ink-100 bg-ink-50 py-12 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-ink-900 mb-8 text-center">Why take this course</h2>
      ...
      <section className="border-t border-ink-100 py-12 sm:py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-ink-900 mb-8">How each lesson works</h2>
      ...
      <section className={`bg-gradient-to-br ${theme.heroFrom} to-ink-900 py-12 sm:py-14 relative overflow-hidden`}>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-2">{resumeTarget ? 'Keep going' : 'Ready to start?'}</h2>
