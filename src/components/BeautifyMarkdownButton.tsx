...
// Hand-written rather than imported from '@/graphql/mutations' — that file
// is generated by introspecting the *live* deployed API (see
// package.json's schema:update), and beautifyLessonMarkdown hasn't been
// deployed yet as of this component's authoring. Same shape codegen will
// eventually produce; swap to the generated export once `schema:update`
// has been run against a deploy that includes it.
const beautifyLessonMarkdown = /* GraphQL */ `mutation BeautifyLessonMarkdown($text: String!) {
  beautifyLessonMarkdown(text: $text)
}`;

interface BeautifyLessonMarkdownMutation {
  beautifyLessonMarkdown: string;
}

interface BeautifyLessonMarkdownMutationVariables {
  text: string;
}
